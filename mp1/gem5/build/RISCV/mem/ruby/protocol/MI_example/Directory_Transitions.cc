                                        ...
                                        Addr addr)
{
  ...
  case HASH_FUN(Directory_State_M_DWR, Directory_Event_PUTX_NotOwner):
  case HASH_FUN(Directory_State_M_DRD, Directory_Event_PUTX_NotOwner):
  case HASH_FUN(Directory_State_M_DRDI, Directory_Event_PUTX_NotOwner):
  case HASH_FUN(Directory_State_M_DWRI, Directory_Event_PUTX_NotOwner):
    if (!(*m_forwardFromDir_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
