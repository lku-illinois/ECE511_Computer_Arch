...
#ifndef __MI_example_ResponseMsg_HH__
#define __MI_example_ResponseMsg_HH__
...
{
  public:
ResponseMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_DataBlk(blockSize)
{
        setRubySystem(rs);
    ...
    ResponseMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_addr, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const MessageSizeType& local_MessageSize)
...
#endif // __MI_example_ResponseMsg_HH__
