...
#ifndef __MI_example_DMARequestMsg_HH__
#define __MI_example_DMARequestMsg_HH__
...
{
  public:
DMARequestMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_DataBlk(blockSize)
{
        setRubySystem(rs);
    ...
    DMARequestMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const DMARequestType& local_Type, const Addr& local_PhysicalAddress, const Addr& local_LineAddress, const MachineID& local_Requestor, const NetDest& local_Destination, const DataBlock& local_DataBlk, const int& local_Len, const MessageSizeType& local_MessageSize)
...
#endif // __MI_example_DMARequestMsg_HH__
