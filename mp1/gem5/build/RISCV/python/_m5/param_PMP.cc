...
py::module_ m = m_internal.def_submodule("param_PMP");
    ...
    py::class_<gem5::RiscvISA::PMP, gem5::SimObject, std::unique_ptr<gem5::RiscvISA::PMP, py::nodelete>>(m, "gem5_COLONS_RiscvISA_COLONS_PMP")
        ;
 ...
 */
[[maybe_unused]] gem5::RiscvISA::PMP *
DummyPMPShunt<gem5::RiscvISA::PMP>::Params::create() const
{
    return DummyPMPShunt<gem5::RiscvISA::PMP>::create(*this);
}
