    ...
    : AbstractController(p)
{
    ...
    p.ruby_system->m_num_controllers[MachineType_L2Cache]++;
...
L2Cache_Controller::init()
{
    ...
    m_L2cache_ptr->setRubySystem(m_ruby_system);
...
L2Cache_Controller::regStats()
{
    ...
    if (m_version == 0) {
        ...
        for (L2Cache_Event event = L2Cache_Event_FIRST;
            ...
            int num_controllers =
                m_ruby_system->m_num_controllers[MachineType_L2Cache];
    ...
    const std::vector<L2Cache_Event> out_trans_evs = {};
    const std::vector<L2Cache_Event> in_trans_evs = {};
    const std::unordered_map<L2Cache_Event, std::vector<L2Cache_State>>
                                in_trans_evs_states = {};
    ...
    for (const auto event : in_trans_evs) {
        std::string stat_name =
            "inTransLatHist." + L2Cache_Event_to_string(event);
        statistics::Histogram* t =
            new statistics::Histogram(&stats, stat_name.c_str());
        ...
        for (const auto initial_state : in_trans_evs_states.at(event)) {
            ...
            for (L2Cache_State final_state = L2Cache_State_FIRST;
                ...
                std::string stat_name = "inTransLatHist." +
                    ...
                    L2Cache_State_to_string(final_state) + ".total";
                statistics::Scalar* t =
    ...
    }
{
    ...
    ((*m_DirRequestFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l2_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
}
    ...
    }
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:431: %s.\n", "assert failure");
    ...
    ((*m_L1RequestFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l1_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
}
...
L2Cache_Controller::c_exclusiveReplacement(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:443: %s.\n", "assert failure");
    ...
    ((*m_responseFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l2_response_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
L2Cache_Controller::ct_exclusiveReplacementFromTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:466: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:480: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:499: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:518: %s.\n", "assert failure");
...
L2Cache_Controller::e_sendDataToGetSRequestors(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:531: %s.\n", "assert failure");
...
if (!(((((*m_tbe_ptr).m_L1_GetS_IDs).count()) > (0)))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:532: %s.\n", "assert failure");
...
;
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:534: %s.\n", "assert failure");
    ...
    (*out_msg).m_DataBlk = (*m_cache_entry_ptr).m_DataBlk;
    (*out_msg).m_MessageSize = MessageSizeType_Response_Data;
    ((*m_responseFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l1_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
L2Cache_Controller::ex_sendExclusiveDataToGetSRequestors(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:545: %s.\n", "assert failure");
...
if (!(((((*m_tbe_ptr).m_L1_GetS_IDs).count()) == (1)))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:546: %s.\n", "assert failure");
...
;
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:548: %s.\n", "assert failure");
...
L2Cache_Controller::ee_sendDataToGetXRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:560: %s.\n", "assert failure");
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:561: %s.\n", "assert failure");
    ...
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:566: %s\n", (*out_msg).m_Destination);
    (*out_msg).m_DataBlk = (*m_cache_entry_ptr).m_DataBlk;
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:568: Address: %#x, Destination: %s, DataBlock: %s\n", (*out_msg).m_addr, (*out_msg).m_Destination, (*out_msg).m_DataBlk);
    (*out_msg).m_MessageSize = MessageSizeType_Response_Data;
    ((*m_responseFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l1_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:588: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:601: %s.\n", "assert failure");
...
L2Cache_Controller::i_allocateTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:615: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:656: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:676: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:684: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:726: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:748: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:756: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:763: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:770: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:777: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:786: %s.\n", "assert failure");
...
int
L2Cache_Controller::functionalReadPriority()
{
return (20);
                            ...
                            if ((param_type == CoherenceRequestType_UPGRADE)) {
                                    if (((param_cache_entry != NULL) && (((*param_cache_entry).m_Sharers).isElement(param_requestor)))) {
                                        ...
                                        if ((param_type == CoherenceRequestType_PUTX)) {
                                                ...
                                                DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:287: address: %#x, Request Type: %s\n", param_addr, param_type);
                                                panic("Runtime Error at MESI_Two_Level-L2cache.sm:288: %s.\n", ("Invalid L1 forwarded request type"));
                                                ;
                                            }
                                        }
                                    }
...
#ifndef NDEBUG
if (!((param_cache_entry != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:297: %s.\n", "assert failure");
