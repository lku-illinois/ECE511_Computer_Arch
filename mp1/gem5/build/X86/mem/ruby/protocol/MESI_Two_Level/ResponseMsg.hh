...
#ifndef __MESI_Two_Level_ResponseMsg_HH__
#define __MESI_Two_Level_ResponseMsg_HH__
		...
		, m_DataBlk(blockSize)
{
    ...
    ResponseMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_addr, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_AckCount, const MessageSizeType& local_MessageSize)
...
#endif // __MESI_Two_Level_ResponseMsg_HH__
