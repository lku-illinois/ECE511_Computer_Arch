 ...
 *   /home/leonkuabc/gem5/src/mem/slicc/symbols/StateMachine.py:585
 */

// Created by slicc definition of Module "MESI Directory L1 Cache CMP"

#ifndef __MESI_Two_Level_L1Cache_CONTROLLER_HH__
#define __MESI_Two_Level_L1Cache_CONTROLLER_HH__
...
{
  public:
    typedef MESI_Two_Level_L1Cache_ControllerParams Params;
...
private:
    ...
    Cycles m_llsc_lock_timeout_latency;
    bool m_use_llsc_lock;
    ...
    bool isLoadLinked(L1Cache_TBE* param_tbe);
    ...
    void z_stallAndWaitL1RequestQueue(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr);
    ...
    void ll_scheduleLoadLinkedLockTimeout(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr);
    /** \brief Unset LL/SC lock timer. */
    void ll_unsetLoadLinkedLockTimer(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr);
    /** \brief Set the isLoadLinked flag. */
    void ll_markLoadLinked(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr);

    // Objects
    TBETable<L1Cache_TBE>* m_TBEs_ptr;
    TimerTable* m_llscLockTimerTable_ptr;
...
#endif // __MESI_Two_Level_L1Cache_CONTROLLER_H__
