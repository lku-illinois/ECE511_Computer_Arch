    ...
    : AbstractController(p)
{
    ...
    p.ruby_system->m_num_controllers[MachineType_L1Cache]++;
    ...
    m_llsc_lock_timeout_latency = p.llsc_lock_timeout_latency;
    m_use_llsc_lock = p.use_llsc_lock;
...
L1Cache_Controller::init()
{
    ...
    m_llscLockTimerTable_ptr  = new TimerTable();
    assert(m_llscLockTimerTable_ptr != NULL);
    m_l2_select_low_bit_ptr = new int;
    (*m_l2_select_low_bit_ptr) = m_ruby_system->getBlockSizeBits();
    m_L1Icache_ptr->setRubySystem(m_ruby_system);
    m_L1Dcache_ptr->setRubySystem(m_ruby_system);

    (*m_prefetcher_ptr).setController(this);

    (*m_llscLockTimerTable_ptr).setConsumer(this);
    ...
    possibleTransition(L1Cache_State_IS, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_IM, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_IS_I, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_M_I, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_SM, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_SINK_WB_ACK, L1Cache_Event_Load_Linked);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_L1_Replacement);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_L1_Replacement);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GETS);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GETX);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GET_INSTR);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Inv);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GETS);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GETX);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GET_INSTR);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Inv);
    possibleTransition(L1Cache_State_PF_IS, L1Cache_Event_Store);
    possibleTransition(L1Cache_State_PF_IS, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_PF_IS_I, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_PF_L1_Replacement);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_PF_L1_Replacement);
    ...
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_PF_Load);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_PF_Store);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_PF_Ifetch);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_PF_Load);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_PF_Store);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_PF_Ifetch);
    possibleTransition(L1Cache_State_NP, L1Cache_Event_Load);
    possibleTransition(L1Cache_State_I, L1Cache_Event_Load);
    possibleTransition(L1Cache_State_NP, L1Cache_Event_Load_Linked);
    possibleTransition(L1Cache_State_I, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_PF_IM, L1Cache_Event_Load_Linked);
    possibleTransition(L1Cache_State_PF_SM, L1Cache_Event_Store);
    possibleTransition(L1Cache_State_PF_SM, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_S, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_E, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_M, L1Cache_Event_Load_Linked);
    ...
    possibleTransition(L1Cache_State_IM, L1Cache_Event_LLSC_Data_all_Acks);
    ...
    possibleTransition(L1Cache_State_SM, L1Cache_Event_LLSC_Ack_all);
    ...
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Load);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Load_Linked);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Load);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Load_Linked);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Store);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Store);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_Ifetch);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_Ifetch);
    possibleTransition(L1Cache_State_LLSC_E, L1Cache_Event_LLSC_Timeout);
    possibleTransition(L1Cache_State_LLSC_M, L1Cache_Event_LLSC_Timeout);
...
L1Cache_Controller::regStats()
{
    ...
    if (m_version == 0) {
        ...
        for (L1Cache_Event event = L1Cache_Event_FIRST;
            ...
            int num_controllers =
                m_ruby_system->m_num_controllers[MachineType_L1Cache];
...
{
    std::shared_ptr<RequestMsg> out_msg = std::make_shared<RequestMsg>(clockEdge(),     m_ruby_system->getBlockSizeBytes(), m_ruby_system);
    (*out_msg).m_addr = addr;
    ...
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:594: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    ...
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
}
    ...
    }
{
    ...
    (*out_msg).m_Requestor = m_machineID;
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:611: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    (*out_msg).m_MessageSize = MessageSizeType_Control;
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    ...
    }
{
    ...
    (*out_msg).m_Requestor = m_machineID;
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:628: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    (*out_msg).m_MessageSize = MessageSizeType_Control;
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    ...
    }
{
    ...
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:651: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
}
    ...
    }
{
    ...
    (*out_msg).m_Requestor = m_machineID;
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:663: %s\n", m_machineID);
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:666: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    (*out_msg).m_MessageSize = MessageSizeType_Control;
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    ...
    }
{
    ...
    (*out_msg).m_Type = CoherenceRequestType_GETX;
    (*out_msg).m_Requestor = m_machineID;
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:681: %s\n", m_machineID);
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:686: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    (*out_msg).m_MessageSize = MessageSizeType_Control;
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    ...
    }
{
    ...
    (*out_msg).m_Requestor = m_machineID;
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:703: address: %#x, destination: %s\n", addr, (*out_msg).m_Destination);
    (*out_msg).m_MessageSize = MessageSizeType_Control;
    (*out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
    (*out_msg).m_AccessMode = ((*in_msg_ptr)).m_AccessMode;
    ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_request_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    ...
    }
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:715: %s.\n", "assert failure");
    ...
    ((*m_responseFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_response_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
}
...
L1Cache_Controller::d2_sendDataToL2(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:729: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:744: %s.\n", "assert failure");
...
L1Cache_Controller::d2t_sendDataToL2_fromTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:758: %s.\n", "assert failure");
...
L1Cache_Controller::f_sendDataToL2(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:784: %s.\n", "assert failure");
...
L1Cache_Controller::ft_sendDataToL2_fromTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:798: %s.\n", "assert failure");
...
L1Cache_Controller::forward_eviction_to_cpu(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
           if (m_send_evictions) {
        DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:825: Sending invalidation for %#x to the CPU\n", addr);
...
L1Cache_Controller::g_issuePUTX(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L1cache.sm:832: %s.\n", "assert failure");
    ...
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
        ...
        ((*m_requestFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_l1_response_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    }
...
L1Cache_Controller::j_sendUnblock(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    (*out_msg).m_MessageSize = MessageSizeType_Response_Control;
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:856: %#x\n", addr);
    ((*m_unblockFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l2_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
L1Cache_Controller::jj_sendExclusiveUnblock(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    (((*out_msg).m_Destination).add((mapAddressToRange(addr, MachineType_L2Cache, (*m_l2_select_low_bit_ptr), m_l2_select_num_bits, (intToID((0)))))));
    (*out_msg).m_MessageSize = MessageSizeType_Response_Control;
    DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:868: %#x\n", addr);
    ((*m_unblockFromL1Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l2_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
L1Cache_Controller::h_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:876: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:877: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::hx_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:892: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:893: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::hh_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:901: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:902: %s\n", (*m_cache_entry_ptr).m_DataBlk);
(((*m_L1Dcache_ptr)).setMRU(m_cache_entry_ptr));
...
L1Cache_Controller::hhx_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:910: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L1cache.sm:911: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::i_allocateTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:920: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:951: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:959: %s.\n", "assert failure");
...
/** \brief Stall and wait the L1 network request queue */
void
L1Cache_Controller::z_stallAndWaitL1RequestQueue(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing z_stallAndWaitL1RequestQueue\n");
    try {
               stallBuffer(&((*m_requestToL1Cache_ptr)), addr);
        (*m_requestToL1Cache_ptr).stallMessage(addr, clockEdge());
        

    } catch (const RejectException & e) {
       fatal("Error in action L1Cache:z_stallAndWaitL1RequestQueue: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}
...
L1Cache_Controller::mp_markPrefetched(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:1049: %s.\n", "assert failure");
...
/** \brief Schedule LL/SC lock timeout. */
void
L1Cache_Controller::ll_scheduleLoadLinkedLockTimeout(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing ll_scheduleLoadLinkedLockTimeout\n");
    try {
       (((*m_llscLockTimerTable_ptr)).set(addr, ((clockEdge()) + (cyclesToTicks(m_llsc_lock_timeout_latency)))));

    } catch (const RejectException & e) {
       fatal("Error in action L1Cache:ll_scheduleLoadLinkedLockTimeout: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}

/** \brief Unset LL/SC lock timer. */
void
L1Cache_Controller::ll_unsetLoadLinkedLockTimer(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing ll_unsetLoadLinkedLockTimer\n");
    try {
       (((*m_llscLockTimerTable_ptr)).unset(addr));

    } catch (const RejectException & e) {
       fatal("Error in action L1Cache:ll_unsetLoadLinkedLockTimer: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}

/** \brief Set the isLoadLinked flag. */
void
L1Cache_Controller::ll_markLoadLinked(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing ll_markLoadLinked\n");
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:1063: %s.\n", "assert failure");

}
#endif
;
(*m_tbe_ptr).m_isLoadLinked = (true);

    } catch (const RejectException & e) {
       fatal("Error in action L1Cache:ll_markLoadLinked: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}
...
if (!((((((*m_L1Dcache_ptr)).isTagPresent(param_addr)) && (((*m_L1Icache_ptr)).isTagPresent(param_addr))) == (false)))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:218: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((((((*m_L1Dcache_ptr)).isTagPresent(param_addr)) && (((*m_L1Icache_ptr)).isTagPresent(param_addr))) == (false)))) {
    panic("Runtime Error at MESI_Two_Level-L1cache.sm:229: %s.\n", "assert failure");
...
L1Cache_Controller::mandatory_request_type_to_event(const RubyRequestType& param_type)
{
    if ((param_type == RubyRequestType_LD)) {
        return L1Cache_Event_Load;
            ...
            if ((param_type == RubyRequestType_Load_Linked)) {
                    if (m_use_llsc_lock) {
                        return L1Cache_Event_Load_Linked;
                    } else {
                        return L1Cache_Event_Load;
                    }
                } else {
                        if ((param_type == RubyRequestType_IFETCH)) {
                            return L1Cache_Event_Ifetch;
                                ...
                                if (((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC))) {
                                    ...
                                    panic("Runtime Error at MESI_Two_Level-L1cache.sm:302: %s.\n", ("Invalid RubyRequestType"));
                                    ;
                                }
                            }
                        }
        ...
        return L1Cache_Event_PF_Load;
            ...
            if ((param_type == RubyRequestType_IFETCH)) {
                return L1Cache_Event_PF_Ifetch;
                    ...
                    if ((((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC)) || (param_type == RubyRequestType_Load_Linked))) {
                        return L1Cache_Event_PF_Store;
                    } else {
                        panic("Runtime Error at MESI_Two_Level-L1cache.sm:316: %s.\n", ("Invalid RubyRequestType"));
                        ;
                    }
                }
            }
...
bool
L1Cache_Controller::isLoadLinked(L1Cache_TBE* param_tbe)
{
return (*param_tbe).m_isLoadLinked;
...
{
{
    std::shared_ptr<RubyRequest> out_msg = std::make_shared<RubyRequest>(clockEdge(),     m_ruby_system->getBlockSizeBytes(), m_ruby_system);
    (*out_msg).m_LineAddress = param_address;
    (*out_msg).m_Type = param_type;
    (*out_msg).m_AccessMode = RubyAccessMode_Supervisor;
    ((*m_optionalQueue_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles((1))), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
