...
L1Cache_Event_to_string(const L1Cache_Event& obj)
{
    switch(obj) {
      ...
      case L1Cache_Event_PF_Store:
        return "PF_Store";
      case L1Cache_Event_Load_Linked:
        return "Load_Linked";
      case L1Cache_Event_LLSC_Data_all_Acks:
        return "LLSC_Data_all_Acks";
      case L1Cache_Event_LLSC_Ack_all:
        return "LLSC_Ack_all";
      case L1Cache_Event_LLSC_Timeout:
        return "LLSC_Timeout";
      default:
...
string_to_L1Cache_Event(const std::string& str)
{
    ...
    } else if (str == "LLSC_Data_all_Acks") {
        return L1Cache_Event_LLSC_Data_all_Acks;
    } else if (str == "LLSC_Ack_all") {
        return L1Cache_Event_LLSC_Ack_all;
    } else if (str == "LLSC_Timeout") {
        return L1Cache_Event_LLSC_Timeout;
    } else {
