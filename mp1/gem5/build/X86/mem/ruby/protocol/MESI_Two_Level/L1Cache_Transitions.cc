 ...
 *   /home/leonkuabc/gem5/src/mem/slicc/symbols/StateMachine.py:1946
 */
                                        ...
                                        Addr addr)
{
  ...
  case HASH_FUN(L1Cache_State_IS, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_IM, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_IS_I, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_M_I, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_SM, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_SINK_WB_ACK, L1Cache_Event_Load_Linked):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_Store):
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_Load_Linked):
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_Store):
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GETS):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GETX):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Fwd_GET_INSTR):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Inv):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GETS):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GETX):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Fwd_GET_INSTR):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Inv):
    z_stallAndWaitL1RequestQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_PF_L1_Replacement):
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_PF_Load):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_PF_Store):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_PF_Ifetch):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_PF_Load):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_PF_Store):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_PF_Ifetch):
  ...
  case HASH_FUN(L1Cache_State_NP, L1Cache_Event_Load_Linked):
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_Load_Linked):
    ...
    oo_allocateL1DCacheBlock(m_tbe_ptr, m_cache_entry_ptr, addr);
    i_allocateTBE(m_tbe_ptr, m_cache_entry_ptr, addr);
    ll_markLoadLinked(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_PF_IM, L1Cache_Event_Load_Linked):
    next_state = L1Cache_State_IM; m_curTransitionNextState = next_state;
    uu_profileDataMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ppm_observePfMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ll_markLoadLinked(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_PF_SM, L1Cache_Event_Load_Linked):
    next_state = L1Cache_State_SM; m_curTransitionNextState = next_state;
    uu_profileDataMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ppm_observePfMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ll_markLoadLinked(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Load):
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Load_Linked):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Load):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Load_Linked):
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Ifetch):
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Ifetch):
  ...
  case HASH_FUN(L1Cache_State_S, L1Cache_Event_Load_Linked):
    next_state = L1Cache_State_SM; m_curTransitionNextState = next_state;
    if (!(*m_TBEs_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    if (!(*m_requestFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
  ...
  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_Store):
    hh_store_hit(m_tbe_ptr, m_cache_entry_ptr, addr);
    uu_profileDataHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    po_observeHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    k_popMandatoryQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_E, L1Cache_Event_Load_Linked):
    next_state = L1Cache_State_LLSC_E; m_curTransitionNextState = next_state;
    h_load_hit(m_tbe_ptr, m_cache_entry_ptr, addr);
    uu_profileDataHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    po_observeHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    ll_scheduleLoadLinkedLockTimeout(m_tbe_ptr, m_cache_entry_ptr, addr);
    k_popMandatoryQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_M, L1Cache_Event_Load_Linked):
    next_state = L1Cache_State_LLSC_M; m_curTransitionNextState = next_state;
    h_load_hit(m_tbe_ptr, m_cache_entry_ptr, addr);
    uu_profileDataHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    po_observeHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    ll_scheduleLoadLinkedLockTimeout(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_IM, L1Cache_Event_LLSC_Data_all_Acks):
    next_state = L1Cache_State_LLSC_E; m_curTransitionNextState = next_state;
    if (!(*m_unblockFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    u_writeDataToL1Cache(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_SM, L1Cache_Event_LLSC_Ack_all):
    next_state = L1Cache_State_LLSC_E; m_curTransitionNextState = next_state;
    if (!(*m_unblockFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    jj_sendExclusiveUnblock(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_Store):
    next_state = L1Cache_State_LLSC_M; m_curTransitionNextState = next_state;
    hh_store_hit(m_tbe_ptr, m_cache_entry_ptr, addr);
    uu_profileDataHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    po_observeHit(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_LLSC_E, L1Cache_Event_LLSC_Timeout):
    next_state = L1Cache_State_E; m_curTransitionNextState = next_state;
    ll_unsetLoadLinkedLockTimer(m_tbe_ptr, m_cache_entry_ptr, addr);
    kd_wakeUpDependents(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;

  case HASH_FUN(L1Cache_State_LLSC_M, L1Cache_Event_LLSC_Timeout):
    next_state = L1Cache_State_M; m_curTransitionNextState = next_state;
    ll_unsetLoadLinkedLockTimer(m_tbe_ptr, m_cache_entry_ptr, addr);
    kd_wakeUpDependents(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
